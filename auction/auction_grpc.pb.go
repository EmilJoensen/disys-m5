...
type AuctionClient interface {
	...
	Result(ctx context.Context, in *ResultVoid, opts ...grpc.CallOption) (*ResultOutcome, error)
}
...
func (c *auctionClient) Result(ctx context.Context, in *ResultVoid, opts ...grpc.CallOption) (*ResultOutcome, error) {
	out := new(ResultOutcome)
...
type AuctionServer interface {
	...
	Result(context.Context, *ResultVoid) (*ResultOutcome, error)
...
func (UnimplementedAuctionServer) Result(context.Context, *ResultVoid) (*ResultOutcome, error) {
...
func _Auction_Result_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuctionServer).Result(ctx, req.(*ResultVoid))
	}
	return interceptor(ctx, in, info, handler)
}
